...
public class TodoServiceTest {
    ...
    void testFindAll() {
        ...
        assertEquals(TEST_TITLE, result.getFirst().title());
    ...
    void testUpdate() {
        ...
        updatedTodo.setAssignedTo(person);
        ...
        assertEquals(TEST_PERSON_ID, result.assignedToId());
        verify(todoRepository).findById(TEST_TODO_ID);
    ...
    void testFindByPersonId() {
        // Arrange
        when(todoRepository.findByAssignedTo_Id(TEST_PERSON_ID)).thenReturn(List.of(todo));

        // Act
        List<TodoDto> result = todoService.findByAssignedTo_Id(TEST_PERSON_ID);

        // Assert
        assertNotNull(result);
        assertFalse(result.isEmpty());
        assertEquals(TEST_TITLE, result.getFirst().title());
        verify(todoRepository).findByAssignedTo_Id(TEST_PERSON_ID);
    }
    ...
    void testFindByCompleted() {
        ...
        assertNotNull(result);
        assertFalse(result.isEmpty());
        assertFalse(result.getFirst().completed());
