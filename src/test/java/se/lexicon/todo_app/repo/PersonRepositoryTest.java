...
class PersonRepositoryTest {
    ...
    void testExistsByEmail() {
        ...
        // Act
        boolean exists = personRepository.existsByEmailIgnoreCase("jane.doe@example.com");
    ...
    void testExistsByEmailFalse() {
        // Act
        boolean exists = personRepository.existsByEmailIgnoreCase("unknown@example.com");
    ...
    void testUpdatePersonName() {
        ...
        // Act
        personRepository.save(person);
        var updatedPerson = personRepository.findByEmailIgnoreCase("alice@example.com");
    ...
    void testDeletePersonByEmail() {
        ...
        boolean exists = personRepository.existsByEmailIgnoreCase("bob@example.com");
